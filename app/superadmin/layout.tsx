    ...
    <div className="flex h-full flex-col bg-sidebar text-sidebar-foreground">
      <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-4">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-semibold leading-tight">Super Admin</span>
      ...
      {user && (
        <div className="border-t border-sidebar-border p-3 space-y-1">
          ...
          <p className="px-3 text-xs text-sidebar-foreground/40">Superadmin</p>
        </div>
      )}
      ...
      <div className="border-t border-sidebar-border p-3 flex items-center justify-between">
        ...
        <Button variant="ghost" size="icon" onClick={logout}
          className="text-sidebar-foreground hover:bg-sidebar-accent" title="Cerrar sesión">
